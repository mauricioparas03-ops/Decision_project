...
def select_action(state):
    ...
    M = 500  # Big-M incrementato per maggiore robustezza
    eps = 0.001 
    ...
    if t < 9:
        ...
        # Future overrides (Inertia fixed logic)
        ...
        # Big-M per Linearizzazione Esatta: z = (x + 1) * y
